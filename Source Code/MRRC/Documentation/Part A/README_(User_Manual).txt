...
```
    --fleet=path/to/fleet.csv --rentals=path/to/rentals.csv --customers=path/to/customers.csv
```
...
This sequence will very simpily draw a table to the console containing details for every rental in the Rentals.
...
The functionality for the Search Vehicles, Rent Vehicle, and Return Vehicle sequences has not yet been implement (Part B tasks).

These sequences will direct the user back to the previous menu.
